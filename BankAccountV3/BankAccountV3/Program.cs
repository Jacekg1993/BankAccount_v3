...
namespace BankAccountV3
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            UserBankB.MakeDeposit(1000, DateTime.Now, "jakas wplata 2");
            UserBankB.MakeWithdrawal(3000, DateTime.Now, "jakas wyplata 2");

            Console.WriteLine("________________");
            Console.WriteLine(UserBankA.GetAccountHistory());
            Console.WriteLine("________________");
            Console.WriteLine(UserBankB.GetAccountHistory());
